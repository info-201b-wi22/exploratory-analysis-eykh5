...
ggplot(data = AAPL) + geom_point(mapping = aes(x = as.Date(Date), y = cumulative_profit)) + geom_point(mapping = aes(x = as.Date(Date), y = all_one_day_cumulative_profit, color = all_one_day_cumulative_profit)) + 
